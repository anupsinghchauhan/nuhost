                     ...
                     <div class="row">
                        ...
                        <div class="cart-body">
                           ...
                           <form method="post" action="{{URL('add-domain-process')}}">
                              @csrf
                           <input type="hidden" name="_qty" value="{{$cart[array_keys($cart)[0]]['_qty']}}">
                           <input type="hidden" name="_price" value="{{$cart[array_keys($cart)[0]]['_price']}}">
                           <input type="hidden" name="_name" value="{{$cart[array_keys($cart)[0]]['_name']}}">
